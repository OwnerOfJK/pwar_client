...
export function setupWorld(provider: DojoProvider) {
  ...
  const build_actions_alertPlayer_calldata = (
  ...
  const build_allowed_app_actions_setPixel_calldata = (
  ...
  const allowed_app_actions_setPixel = async (
    snAccount: Account | AccountInterface,
    defaultParams: models.DefaultParameters,
  ) => {
    try {
  ...
  const build_guild_actions_addMember_calldata = (
    gameId: BigNumberish,
  ...
  const guild_actions_addMember = async (
    snAccount: Account | AccountInterface,
    gameId: BigNumberish,
    guildId: BigNumberish,
    newMember: string,
  ...
  const build_guild_actions_createGuild_calldata = (
    gameId: BigNumberish,
    guildName: BigNumberish,
  ): DojoCall => {
    return {
      contractName: "guild_actions",
  ...
  const guild_actions_createGuild = async (
    snAccount: Account | AccountInterface,
    gameId: BigNumberish,
    guildName: BigNumberish,
  ) => {
  ...
  const build_guild_actions_getGuildPoints_calldata = (
    gameId: BigNumberish,
    guildId: BigNumberish,
  ): DojoCall => {
    return {
  ...
  const guild_actions_getGuildPoints = async (
    snAccount: Account | AccountInterface,
    gameId: BigNumberish,
    guildId: BigNumberish,
  ) => {
  ...
  const build_guild_actions_getPlayerCommit_calldata = (
  ...
  const guild_actions_getPlayerCommit = async (
    snAccount: Account | AccountInterface,
    playerAddress: string,
  ) => {
    try {
  ...
  const build_guild_actions_getPlayerOwns_calldata = (
    playerAddress: string,
  ): DojoCall => {
    return {
      contractName: "guild_actions",
  ...
  const guild_actions_getPlayerOwns = async (
    snAccount: Account | AccountInterface,
    playerAddress: string,
  ) => {
    try {
  ...
  const build_guild_actions_isMember_calldata = (
    gameId: BigNumberish,
    guildId: BigNumberish,
    member: string,
  ): DojoCall => {
  ...
  const guild_actions_isMember = async (
    snAccount: Account | AccountInterface,
    gameId: BigNumberish,
    guildId: BigNumberish,
    member: string,
  ...
  const build_guild_actions_joinGuild_calldata = (
    gameId: BigNumberish,
    guildId: BigNumberish,
  ): DojoCall => {
    return {
  ...
  const guild_actions_joinGuild = async (
    snAccount: Account | AccountInterface,
    gameId: BigNumberish,
    guildId: BigNumberish,
  ) => {
  ...
  const build_guild_actions_removeMember_calldata = (
    gameId: BigNumberish,
    guildId: BigNumberish,
    member: string,
  ): DojoCall => {
  ...
  const guild_actions_removeMember = async (
    snAccount: Account | AccountInterface,
    gameId: BigNumberish,
    guildId: BigNumberish,
    member: string,
  ...
  const build_p_war_actions_createGame_calldata = (
  ...
  const p_war_actions_createGame = async (
    snAccount: Account | AccountInterface,
    origin: models.Position,
  ) => {
    try {
  ...
  const build_p_war_actions_createGameGuilds_calldata = (
    gameId: BigNumberish,
    guildDispatcher: models.IGuildDispatcher,
  ): DojoCall => {
    return {
      contractName: "p_war_actions",
  ...
  const p_war_actions_createGameGuilds = async (
    snAccount: Account | AccountInterface,
    gameId: BigNumberish,
    guildDispatcher: models.IGuildDispatcher,
  ) => {
  ...
  const build_p_war_actions_endGame_calldata = (
    gameId: BigNumberish,
  ): DojoCall => {
    return {
      contractName: "p_war_actions",
  ...
  const p_war_actions_endGame = async (
    snAccount: Account | AccountInterface,
    gameId: BigNumberish,
  ) => {
    try {
  ...
  const build_p_war_actions_getGameId_calldata = (
    position: models.Position,
  ): DojoCall => {
    return {
      contractName: "p_war_actions",
  ...
  const p_war_actions_getGameId = async (position: models.Position) => {
    try {
      return await provider.call(
        "p_war",
        build_p_war_actions_getGameId_calldata(position),
      );
    } catch (error) {
      console.error(error);
      throw error;
  ...
  const build_p_war_actions_interact_calldata = (
    defaultParams: models.DefaultParameters,
  ): DojoCall => {
    return {
      contractName: "p_war_actions",
  ...
  const p_war_actions_interact = async (
    snAccount: Account | AccountInterface,
    defaultParams: models.DefaultParameters,
  ) => {
    try {
  ...
  const build_p_war_actions_placePixel_calldata = (
    app: string,
    defaultParams: models.DefaultParameters,
  ): DojoCall => {
    return {
  ...
  const p_war_actions_placePixel = async (
    snAccount: Account | AccountInterface,
    app: string,
    defaultParams: models.DefaultParameters,
  ) => {
  ...
  const build_p_war_actions_updatePixel_calldata = (
    pixelUpdate: models.PixelUpdate,
  ): DojoCall => {
    return {
      contractName: "p_war_actions",
  ...
  const p_war_actions_updatePixel = async (
    snAccount: Account | AccountInterface,
    pixelUpdate: models.PixelUpdate,
  ) => {
    try {
  ...
  const build_propose_actions_activateProposal_calldata = (
    gameId: BigNumberish,
    index: BigNumberish,
    clearData: Array<Position>,
  ): DojoCall => {
    return {
  ...
  const propose_actions_activateProposal = async (
    snAccount: Account | AccountInterface,
    gameId: BigNumberish,
    index: BigNumberish,
    clearData: Array<Position>,
    ...
    try {
      return await provider.execute(
        snAccount,
        build_propose_actions_activateProposal_calldata(
          gameId,
          index,
          clearData,
        ),
  ...
  const build_propose_actions_addNewColor_calldata = (
    gameId: BigNumberish,
    index: BigNumberish,
    game: models.Game,
  ...
  const propose_actions_addNewColor = async (
    snAccount: Account | AccountInterface,
    gameId: BigNumberish,
    index: BigNumberish,
    game: models.Game,
    ...
    try {
      return await provider.execute(
        snAccount,
        build_propose_actions_addNewColor_calldata(
          gameId,
          index,
          game,
          proposal,
  ...
  const build_propose_actions_createProposal_calldata = (
    gameId: BigNumberish,
    proposalType: BigNumberish,
    targetArgs1: BigNumberish,
    targetArgs2: BigNumberish,
  ): DojoCall => {
    return {
      contractName: "propose_actions",
  ...
  const propose_actions_createProposal = async (
    snAccount: Account | AccountInterface,
    gameId: BigNumberish,
    proposalType: BigNumberish,
    targetArgs1: BigNumberish,
    ...
    try {
      return await provider.execute(
        snAccount,
        build_propose_actions_createProposal_calldata(
          gameId,
          proposalType,
          targetArgs1,
          targetArgs2,
  ...
  const build_propose_actions_resetToWhite_calldata = (
    gameId: BigNumberish,
    index: BigNumberish,
    game: models.Game,
    proposal: models.Proposal,
  ...
  const propose_actions_resetToWhite = async (
    snAccount: Account | AccountInterface,
    gameId: BigNumberish,
    index: BigNumberish,
    game: models.Game,
    ...
    try {
      return await provider.execute(
        snAccount,
        build_propose_actions_resetToWhite_calldata(
          gameId,
          index,
          game,
          proposal,
  ...
  const build_voting_actions_vote_calldata = (
    gameId: BigNumberish,
    index: BigNumberish,
    usePx: BigNumberish,
    isInFavor: boolean,
  ...
  const voting_actions_vote = async (
    snAccount: Account | AccountInterface,
    gameId: BigNumberish,
    index: BigNumberish,
    usePx: BigNumberish,
  ...
  return {
    ...
    guild_actions: {
      ...
      buildGetGuildContractAddressCalldata:
        build_guild_actions_getGuildContractAddress_calldata,
      ...
      buildGetPlayerCommitCalldata:
        build_guild_actions_getPlayerCommit_calldata,
    ...
    p_war_actions: {
      ...
      buildCreateGameGuildsCalldata:
        build_p_war_actions_createGameGuilds_calldata,
