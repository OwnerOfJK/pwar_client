...
export type IPwarContext = {
    ...
    center: Coordinate
    zoom: number
    selectedUnit: string | null // new
    selectedPosition: Coordinate | null // new
    ...
    // Add the new interaction method
...
// Create the hook to use this provider
