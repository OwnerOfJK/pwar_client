...
// ../node_modules/.pnpm/starknetkit@2.6.1_starknet@6.21.0/node_modules/starknetkit/dist/index-ae0f52d0.js
var c = Object.defineProperty;
var y = (A2, D, M) => D in A2 ? c(A2, D, { enumerable: true, configurable: true, writable: true, value: M }) : A2[D] = M;
var w = (A2, D, M) => (y(A2, typeof D != "symbol" ? D + "" : D, M), M);
...
var a = class extends F {
  ...
  async ready() {
    ...
    }))?.includes(k.ACCOUNTS) : false;
  }
  async account(M) {
    if (this.ensureWallet(), await this.isLocked() || !this._wallet)
      throw new A();
    const N2 = await this.request({
      type: "wallet_requestAccounts",
      params: { silent_mode: true }
    });
    return new Account(M, N2[0], "");
  }
  async connect(M = {}) {
    ...
    }), this._wallet.on("networkChanged", (z, L2) => {
      this.onNetworkChanged(z, L2);
    }), await this.onAccountsChanged(I);
    const [N2] = I, j = await this.chainId();
    return this.emit("connect", { account: N2, chainId: j }), {
      account: N2,
      chainId: j
    };
  }
  async disconnect() {
    if (this.ensureWallet(), U(), !this._wallet)
      throw new S();
  ...
  async onAccountsChanged(M) {
    if (!M)
      ...
      const [I] = M;
      if (I) {
        const N2 = await this.chainId();
        this.emit("change", { account: I, chainId: N2 });
      } else
        this.emit("disconnect");
    }
  }
  onNetworkChanged(M, I) {
    if (M) {
      const N2 = BigInt(M), [j] = I || [];
      this.emit("change", { chainId: N2, account: j });
    } else
      this.emit("change", {});
  }
  get wallet() {
...
// ../node_modules/.pnpm/starknetkit@2.6.1_starknet@6.21.0/node_modules/starknetkit/dist/index-32a1e8d5.js
var N = Object.defineProperty;
var k2 = (e, n, t) => n in e ? N(e, n, { enumerable: true, configurable: true, writable: true, value: t }) : e[n] = t;
var r = (e, n, t) => (k2(e, typeof n != "symbol" ? n + "" : n, t), t);
var L = {
...
var B = () => Object.keys(localStorage).some(
...
var _ = "f2e613881f7a0e811295cdd57999e31b";
var g = `<svg
    width="32"
    height="32"
    viewBox="0 0 32 32"
...
var U2 = () => typeof window > "u" || !window?.starknet_argentX ? false : window?.starknet_argentX?.isInAppBrowser;
var W = class extends F {
  ...
  async ensureWallet() {
    const { getStarknetWindowObject: t } = await import("./index-4e71ab95-G6YXM7OU.js"), { chainId: o, projectId: s, dappName: f, description: C2, url: m, icons: I, rpcUrl: b } = this._options, l = q(), y2 = b ?? (!o || o === constants_exports.NetworkName.SN_MAIN ? l.mainnet : l.testnet), A2 = {
    ...
    if (!i)
      throw new R();
    this._wallet = i;
    const c2 = this._wallet;
    await c2.enable(), c2.client.on("session_delete", () => {
      p(), this._wallet = null, U(), document.dispatchEvent(new Event("wallet_disconnected"));
    });
  }
};
var X = class {
...
//# sourceMappingURL=chunk-TCXM5RHN.js.map
